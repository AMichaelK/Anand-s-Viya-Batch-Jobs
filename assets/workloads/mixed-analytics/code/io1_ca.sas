 ...
 *
 * ANTICIPATED RUNTIME:   00:23:00.00 
 * TEST CHARACTERIZATION:  I/O Intensive  
 *
 * SAS PRODUCTS INVOLVED: BASE			  
 * SAS PROCEDURES INVOLVED: DATA   
 *
 * DATA SOURCE: /$asuite/input Hrecs & Precs datasets  
 * DATA CHARACTERIZATION: Large Flat Files - Census
 *
 * COMMENTS:
...
proc datasets library=o;
     delete hrecs_ca_ca&sysparm.;
     delete precs_ca_ca&sysparm.;
run; 
