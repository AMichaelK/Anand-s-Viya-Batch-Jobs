 ...
 *
 * ANTICIPATED RUNTIME:  00:07:29.00
 * TEST CHARACTERIZATION:  I/O Intensive  
 *
 * SAS PRODUCTS INVOLVED:  BASE		 
 * SAS PROCEDURES INVOLVED: SQL
 *
 * DATA SOURCE: Census Data  /$asuite/input/precs_#.sas7bdat  
...
/*** This Test Uses Data Created By Census_Test1 ***/
 ...
 ***************************************************************************/
 ...
 /*** Create a view to the PRECS table ***/
 /*** PRECS is created by Census_test1 ***/

proc sql;
     create view work.nonborn as select serialno
     from in.precs_&sysparm as p where
           citizen in('3','4')
           and p.serialno in( select h.serialno from in.hrecs_&sysparm as h
                              where value='00' and yrbuilt='0') ;
     select count(*) from work.nonborn;
quit;
